...
angular.module('ToDoApp', ['ui.bootstrap'])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'tRlsNxL6Pvoih7afms2oelisec2yFwcvFAh5FSnp';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'SZacKkeLg6TjxXpdQktcCqby1PqWWpFYNFAkydRW';
    })
